  ...
  return (
    <Screen scroll style={styles.screen}>
      ...
      <View style={styles.identity}>
        ...
        <Text style={styles.name}>Your space</Text>
        <Text style={styles.handle}>
          Complete your profile when account services connect.
        </Text>
      </View>

      <View style={styles.stats}>
        <Stat value="—" label="Moments" />
        <Stat value="—" label="Following" />
        <Stat value="—" label="Followers" />
      </View>

      <GlowButton label="Edit profile" variant="secondary" />
      ...
      <View style={styles.section}>
        ...
        <View style={styles.empty}>
          ...
          <Text style={styles.emptyBody}>
            Captured and published moments will live here.
          </Text>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  identity: { alignItems: 'center', marginTop: spacing.xl, gap: 8 },
  avatar: {
    width: 94,
    height: 94,
    borderRadius: 47,
